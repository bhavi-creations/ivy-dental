...
$stmt->fetch();
$stmt->close(); // Statement close cheyali but connection kaadu

// ---------------------------------------------
// 2. FETCH ALL SERVICES FOR DROPDOWN
// ---------------------------------------------
$services = [];
                        ...
                        <div class="card-body">
                            <form id="editblogform" action="addBlog.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="service" class="form-control" required>
                                        ...
                                        foreach ($services as $s) {
                                            $selected = (trim($service) == trim($s)) ? "selected" : "";
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if ($video) { ?>
                                        <small>Current Video : <a href="../../uploads/videos/<?= $video ?>" target="_blank">View</a></small>
                                    <?php } ?>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if ($section1_image) { ?>
                                        <div class="mt-2">
                                            ...
                                            <img src="../../uploads/photos/<?= $section1_image ?>" style="max-width:220px;border:1px solid #ccc;padding:5px;">
                                        </div>
                                    <?php } ?>
                                </div>
