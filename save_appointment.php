...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mailDoctor->Username   = 'Ivorydental02@gmail.com';
        $mailDoctor->Password   = 'bxxyrwrwvsvqpcic';
        ...
        $mailDoctor->addAddress('Ivorydental02@gmail.com');
    ...
    try {
        ...
        $mailPatient->Username   = 'Ivorydental02@gmail.com';
        $mailPatient->Password   = 'bxxyrwrwvsvqpcic';
