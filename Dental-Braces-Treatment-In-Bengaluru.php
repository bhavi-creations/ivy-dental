...
<main>
    ...
    <img src="./assets/img/bg/dental_braces_bg.png" alt="" class="img-fluid">
                ...
                <div class="col-12 col-xl-8">
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <h1 class="root-title">Dental braces</h1>
                            <!-- <h2 class="root-subtitle">Relieve Pain, Save Your Smile</h2> -->

                            <p class="root-copy">
                                Dental braces are orthodontic devices used to correct misaligned teeth and jaw issues. They apply gentle, continuous pressure to gradually shift teeth into the right position. Available in metal, ceramic, or lingual types, braces improve both appearance and oral health by creating a balanced, confident smile.
                            </p>
                        ...
                        <div class="col-12 col-lg-7 d-flex flex-column align-items-center justify-content-center">
                            <div class="hero-wrap ">
                                                                <img src="assets/img/braces_1.png" alt="Image">
