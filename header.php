    ...
    <div class="ul-sidebar">
        ...
        <div>
            <div class="ul-sidebar-txt-block">
                ...
                <p class="descr">At Ivory Dental, Vidyaranyapura, our team of expert dentists and caring support staff is dedicated to delivering compassionate and high-quality dental care that prioritizes your comfort and confidence.</p>
            </div>
                            ...
                            <div class="col-xxl col-lg-3 col-sm-5 col-6 col-xxs-12 ps-5">
                                <div class="ul-header-top-infos">
                                    <span class="ul-header-top-info">
                                        ...
                                        <span class="txt">
                                            <span class="value">Mon - Sat 10.00 am - 8.00 pm</span>
                                        </span>
                                    </span>
                                </div>
                            </div>
