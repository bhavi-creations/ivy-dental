<!-- <div class="col-lg-4 col-md-5">
    <div class="ul-service-details-sidebar">
        <div class="ul-service-details-sidebar-widget">
            ...
            <ul class="ul-service-details-sidebar-links">
                <li><a href="Root-Canal-Treatment-In-Bengaluru.php" class="active">Root canal<i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Teeth-Filling-Treatment-In-Bengaluru.php">Teeth Filling <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Invisalign-Aligners-In-Bengaluru.php">Clear Aligners <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Dental-Braces-Treatment-In-Bengaluru.php">Dental braces <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Dental-Dentures-Treatment-In-Bengaluru.php">Dentures <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Teeth-Whitening-Treatment-In-Bengaluru.php">Teeth Whitening <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Dental-Implants-Treatment-In-Bengaluru.php">Dental Implants <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Teeth-Scaling-Treatment-In-Bengaluru.php">Teeth Scaling <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Smile-Makeover-Treatment-In-Bengaluru.php">Smile Makeover <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Dental-Crown-Bridge-Treatment-In-Bengaluru.php">Crowns & Bridges <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Tooth-Extraction-Treatment-In-Bengaluru.php">Tooth Extraction <i class="flaticon-arrow-up-right"></i></a></li>
                <li><a href="Full-Mouth-Restoration-Treatment-In-Bengaluru.php">Full Mouth Restoration <i class="flaticon-arrow-up-right"></i></a></li>
        </div>
        </ul>
    </div>
    ...
    <div class="ul-service-details-sidebar-widget ul-service-details-sidebar-cta">
        ...
        <div class="ul-service-details-sidebar-cta-content">
            <p class="contact-info">1st floor, IVY DENTAL, JSR Arcade, 592, 13th Cross Rd, HMT Layout 4th Block, Vidyaranyapura, Bengaluru, Karnataka 560097</p>
            ...
            <a href="contact-ivy-dental-hospital.php" class="ul-btn">Contact Us <i class="flaticon-arrow-up-right"></i></a>
        </div>
    </div>
</div> -->
