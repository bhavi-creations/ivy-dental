                ...
                <div class="col-12 col-xl-8">
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <h1 class="root-title">Tooth filling</h1>
                            <!-- <h2 class="root-subtitle">Relieve Pain, Save Your Smile</h2> -->

                            <p class="root-copy">
                                Tooth filling is a simple and effective procedure to repair cavities or minor tooth damage. The decayed portion of the tooth is removed and replaced with a durable filling material that restores its natural shape and function. It prevents further decay, strengthens the tooth, and helps you maintain a healthy smile.
                            </p>
                        </div>
                        ...
                        <div class="col-12 col-lg-7">
                            ...
                            <div class="why-block">
                                ...
                                <p class="why-copy">
                                    Ignoring cavities can lead to severe pain, infection, or even tooth loss. A dental filling not only stops decay but also restores the tooth’s normal function and appearance, ensuring long-term oral health and a confident smile </p>
                            </div>
                        </div>
