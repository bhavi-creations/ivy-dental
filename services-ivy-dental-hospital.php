...
<main>
    ...
    <img src="./assets/img/bg/service_bg.png" alt="" class="img-fluid">
    ...
    <div class="index-third-container">
        ...
        <div class="index-third-header-center">
            ...
            <h2 class="index-third-heading">
                ...
                <span class="gold-text">Every Smile</span>
            </h2>
        ...
        <div class="index-third-cards-row">
         ...
         -webkit-filter:brightness(0) saturate(100%) invert(49%) sepia(81%) saturate(211%) hue-rotate(5deg) brightness(141%) contrast(85%) !important;">
            ...
            <article class="index-third-card">
                ...
                <div class="index-third-card-image">
                    ...
                    <img src="assets/img/service/teeth filling.png"
                         alt="Teeth Filling">
         ...
         -webkit-filter:brightness(0) saturate(100%) invert(49%) sepia(81%) saturate(211%) hue-rotate(5deg) brightness(141%) contrast(85%) !important;">
                    ...
                    <p class="index-third-card-text">
                        Restore your tooth’s strength and function with safe and durable dental fillings.
                    </p>

                    <a href="Teeth-Filling-Treatment-In-Bengaluru.php"
                       class="index-third-card-link">
         ...
         -webkit-filter:brightness(0) saturate(100%) invert(49%) sepia(81%) saturate(211%) hue-rotate(5deg) brightness(141%) contrast(85%) !important;">
            ...
            <article class="index-third-card">
                ...
                <div class="index-third-card-image">
                    ...
                    <img src="assets/img/service/clear aligners.png"
                         alt="Clear Aligners">
         ...
         -webkit-filter:brightness(0) saturate(100%) invert(49%) sepia(81%) saturate(211%) hue-rotate(5deg) brightness(141%) contrast(85%) !important;">
                    ...
                    <p class="index-third-card-text">
                        Straighten your teeth discreetly with advanced clear aligner solutions.
                    </p>

                    <a href="Invisalign-Aligners-In-Bengaluru.php"
                       class="index-third-card-link">
            ...
            <article class="index-third-card">
                ...
                <div class="index-third-card-image">
                    ...
                    <img src="assets/img/service/Dental braces.png"
                         alt="Dental Braces">
         ...
         -webkit-filter:brightness(0) saturate(100%) invert(49%) sepia(81%) saturate(211%) hue-rotate(5deg) brightness(141%) contrast(85%) !important;">
                    ...
                    <p class="index-third-card-text">
                        Achieve a perfect smile with advanced dental braces and orthodontic care.
                    </p>

                    <a href="Dental-Braces-Treatment-In-Bengaluru.php"
                       class="index-third-card-link">
        ...
        <div class="index-third-strip">
            ...
            <div class="index-third-strip-row">
                ...
                <div class="index-third-strip-item">
                    ...
                    <div class="index-third-strip-icon">
                        <i class="bi bi-people"></i>
                    </div>

                    <div>

                        <p class="index-third-strip-title">
                            Families We Care For
                        </p>

                        <p class="index-third-strip-subtitle">
                            All Ages Welcome
                        </p>
                ...
                <a href="index.php"
                   class="index-third-strip-logo">

                    <i class="fa-solid fa-tooth"></i>

                    <span>

                        <span class="index-third-strip-logo-title">
                            IVY DENTAL
                        </span>

                        <span class="index-third-strip-logo-subtitle">
