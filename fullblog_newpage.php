...
<head>
    ...
    <style>
        ...
        .custom-menu {
            border-top: 1px solid #1c482d;
            border-bottom: 1px solid #1c482d;
            padding: 10px 0;
            margin: 20px 0;
            display: flex;
            ...
            <div class="col-lg-8">
                <div class="doctor-card-premium">
                    <div class="doctor-image-wrapper">
                        <img src="assets/img/00.png" class="doctor-profile-img" alt="Dr. Kiran">
                        <div class="experience-badge">24 years Exp</div>
                    </div>
                    <div class="doctor-info">
                        <div class="doctor-title-area">
                            <h2 class="doctor-name">Dr. (Prof) Chiranjeevi Reddy</h2>
                            <span class="doctor-degree">Prosthodontist and Implantologist</span>
                        </div>
                ...
                <h4 class="fw-bold mb-4 d-flex justify-content-center py-3" id="title-1" style="color: #1c482d;"><?php echo $blog['title']; ?></h4>

                <div class="row align-items-center mb-4">
                    <div class="col-lg-7 order-2 order-lg-1">
                        <div class="content-box overlap-right">
                            <p class="text-#1c482d small mb-0" id="short-1"><?php echo getLimitWords($blog['main_content'], 15); ?>...</p>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col-lg-7">
                            <div class="content-box overlap-left">
                                <p class="text-#1c482d small mb-0" id="short-2"><?php echo getLimitWords($blog['full_content'], 15); ?>...</p>
