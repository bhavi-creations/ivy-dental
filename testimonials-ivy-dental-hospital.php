                ...
                <div class="swiper-slide">
                    <div class="ul-feedback">
                        <div class="ul-feedback-reviewer">
                            <div class="ul-feedback-reviewer-img">
                                <img src="assets/img/reviewer-1.jpg" alt="Reviewer Image">
                            </div>

                            <div class="ul-feedback-reviewer-info">
                                <h3 class="ul-feedback-reviewer-name">Shailaja.R gowda</h3>
                            </div>
                        </div>
                        <div class="ul-feedback-rating">
                ...
                <div class="swiper-slide">
                    <div class="ul-feedback">
                        <div class="ul-feedback-reviewer">
                            ...
                            <div class="ul-feedback-reviewer-info">
                                <h3 class="ul-feedback-reviewer-name">Vasu R</h3>
                            </div>
                        </div>
                        <div class="ul-feedback-rating">
                            <i class="flaticon-star"></i>
                ...
                <div class="swiper-slide">
                    <div class="ul-feedback">
                        <div class="ul-feedback-reviewer">
                            ...
                            <div class="ul-feedback-reviewer-info">
                                <h3 class="ul-feedback-reviewer-name">Saiesh Arun kumar</h3>
                            </div>
                        </div>
                        <div class="ul-feedback-rating">
                            <i class="flaticon-star"></i>
                ...
                <div class="swiper-slide">
                    <div class="ul-feedback">
                        <div class="ul-feedback-reviewer">
                            ...
                            <div class="ul-feedback-reviewer-info">
                                <h3 class="ul-feedback-reviewer-name">Johnson Bellary </h3>
                            </div>
                        </div>
                        <div class="ul-feedback-rating">
                            <i class="flaticon-star"></i>
